/*
 * @Author: your name
 * @Date: 2021-08-19 16:27:40
 * @LastEditTime: 2021-08-30 17:21:46
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /aa/src/extension.ts
 */
...
export function activate(context: vscode.ExtensionContext) {
  ...
  const defaultCommand = vscode.workspace
    .getConfiguration()
    .get("i18n-chain.defaultCmd") || "i18n-chain-json";
  if (defaultCommand === "i18n-chain-ts") {
    I18nChainTS();
  }

  if (defaultCommand === "i18n-chain-json") {
    I18nChainJSON();
  }
  ...
  // ts版本
  let disposableTS = vscode.commands.registerCommand("i18n-chain-ts", I18nChainTS);
